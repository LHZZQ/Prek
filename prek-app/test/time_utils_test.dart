...
void main() {
  // Tests for time_utils.dart
  group('sameDay', () {
    test('returns true for same calendar day with different times', () {
      //Create two dates on the same day, at different times
    ...
    test('returns false for different calendar days', () {
      //Create two consecutive days, with the time being very close but spanning across days
